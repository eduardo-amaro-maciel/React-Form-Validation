...
export default function FormContact() {
   ...
   type CreateFormContact = z.infer<typeof contactSchema>;
   ...
   function searchCep(cep: string) {
      fetch(`https://viacep.com.br/ws/${cep}/json/`)
         ...
         .catch(() => console.log("Recusado"));
   }

   function sendForm(data: CreateFormContact) {
      console.log(data);
   }
   ...
   return (
      <Form onSubmit={handleSubmit(sendForm)} className="flex flex-col gap-3 flex-1">
         ...
         <div className="flex gap-4">
            ...
            <div className="flex flex-col flex-1">
               <label htmlFor="data-nascimento" className="mb-1">
                  Data de nascimento
               </label>
               <InputMask
                  mask="99/99/9999"
         ...
         <div className="flex gap-4">
            <div className="flex flex-col flex-1">
               <label htmlFor="cep" className="mb-1">
                  CEP
               </label>
               <InputMask
                  mask="99999-999"
                  ...
                  maskChar={null}
                  {...register("cep")}
                  onBlur={(cep) => searchCep(cep.target.value)}
               />
               {errors.cep && <ErrorMessage>{errors.cep.message}</ErrorMessage>}
            </div>

            <div className="flex flex-col flex-1">
               <label htmlFor="endereco" className="mb-1">
                  Endereço
               </label>
               <input
                  type="text"
         ...
         <div className="flex gap-4">
            <div className="flex flex-col flex-1">
               <label htmlFor="localidade" className="mb-1">
                  Localidade
               </label>
               <input
                  type="text"
            ...
            <div className="flex flex-col flex-1">
               <label htmlFor="selecao" className="mb-1">
                  Escolha uma opção
               </label>
               <Controller
                  control={control}
